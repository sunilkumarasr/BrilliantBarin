...
class SubjectBasrdVideosAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val additionalVideosAdapter = AdditionalVideosAdapter(item.additional_videos)
        holder.recyclerview.layoutManager = LinearLayoutManager(holder.itemView.context, LinearLayoutManager.VERTICAL, false)
        holder.recyclerview.adapter = additionalVideosAdapter
